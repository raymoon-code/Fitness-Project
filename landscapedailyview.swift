...
struct landscapedailyview: View {
...
//                            )
                        //                    .multilineTextAlignment(.center)
                            .foregroundColor(.black)
                            .frame(width: geow * 0.9,height:geoh * 0.01, alignment: .topLeading)
                            .padding()
                        ...
                        }.frame(width: geow * 0.9,height: geoh * 0.25)
                            .cornerRadius(20)
...
#Preview {
    landscapedailyview(selectFeet: .constant(5), selectInch: .constant(7), selectlb: .constant(126), Email: .constant("dnlonda@cougarnet.uh.edu"))
}
